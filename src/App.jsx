...
const BOT_WELCOME = "Hi! I'm QueryBot, your AI Learning Assistant. Ask me anything — I'm here to help you learn and grow. 😊";
const API_BASE = "";
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
          ...
          .sidebar.closed { transform: translateX(-100%) !important; width: 260px !important; opacity: 1 !important; pointer-events: none; }
          .sidebar-overlay { display: block; opacity: 0; pointer-events: none; transition: opacity 0.28s ease; z-index: 49; }
        ...
        @media (max-width: 768px) {
          ...
          .land-icon { width: 60px; height: 60px; font-size: 26px; margin-bottom: 20px; }
          .land-greeting { font-size: 11px; letter-spacing: 2px; margin-bottom: 10px; }
          .land-title { font-size: clamp(28px, 9vw, 42px); }
          .land-sub { font-size: 14px; margin: 12px auto 28px; }
          .land-btn { padding: 13px 28px; font-size: 14px; }
          .land-features { gap: 14px; margin-top: 28px; }
          .land-feat { font-size: 11px; }
          ...
          .chat-inner { padding: 0 12px; gap: 16px; }
          .welcome-block { padding: 12px 0 4px; }
          .welcome-icon { width: 44px; height: 44px; font-size: 20px; margin-bottom: 10px; }
          .welcome-title { font-size: 17px; }
          .welcome-sub { font-size: 13px; }

          /* Messages */
          .msg-row { gap: 8px; }
          .avatar { width: 26px; height: 26px; font-size: 10px !important; }
          .msg-body { max-width: 88%; }
          .msg-name { font-size: 11px; }
          .bubble { padding: 9px 13px; font-size: 13.5px; line-height: 1.6; }
          ...
          /* Suggestions */
          .suggestions { grid-template-columns: 1fr 1fr; gap: 8px; padding: 0 12px; }
          .sug-card { padding: 10px 12px; font-size: 12px; }
          .sug-icon { font-size: 15px; margin-bottom: 4px; }

          /* Input */
          .input-wrap { padding: 6px 12px 12px; }
          .input-box { padding: 8px 8px 8px 13px; border-radius: 12px; }
        ...
        <div className="landing" style={{background: bg, color: text}}>
          ...
          <div className="landing-inner">
            ...
            <h1 className="land-title" style={{color: text}}>
              Meet <span>QueryBot</span><br/>Your AI Tutor
            </h1>
      ...
      {started && (
        <div className="app" style={{background: bg}}>
          ...
          <div className={`sidebar ${isMobile ? (sidebarOpen ? "open-mobile" : "closed") : (sidebarOpen ? "" : "closed")}`} style={{background: surface, borderRight: `1px solid ${border}`}}>
            <div className="sidebar-top" style={{borderBottom:`1px solid ${border}`}}>
              <div className="brand">
                <div className="brand-icon">✦</div>
                <span className="brand-text" style={{color: text}}>QueryBot</span>
              ...
              <div className="prompt-section">
                ...
                {SUGGESTIONS.map((s,i)=>(
                  <div key={i} className="prompt-item" style={{color: textMid}}
                    onMouseEnter={e=>e.currentTarget.style.background=d?"#222":"#ede8e0"}
                    onMouseLeave={e=>e.currentTarget.style.background="transparent"}
                    onClick={()=>{ sendMessage(s); if(isMobile) setSidebarOpen(false); }}>💬&nbsp; {s}</div>
                ))}
              </div>
            </div>

            <div className="sidebar-footer" style={{borderTop:`1px solid ${border}`, color: d?"#444":"#b0a9a0"}}>
              QueryBot AI v2.0<br/>Powered by Groq<br/>© 2025 QueryBot
            </div>
          </div>
          ...
          <div className="main" style={{background: bg}}>
            <div className="topbar" style={{background: bg, borderBottom:`1px solid ${border}`}}>
              <div className="topbar-left">
                ...
                <div>
                  <div className="topbar-title" style={{color: text}}>QueryBot</div>
                ...
                {messages.map((msg, index)=>(
                  ...
                  >
                    ...
                    <div className="msg-body">
                      <div className="msg-name">{msg.sender==="bot"?"QueryBot":"You"}</div>
                      {msg.sender==="bot" ? (
